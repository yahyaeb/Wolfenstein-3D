...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/24 13:08:20 by mmalie            #+#    #+#             */
/*   Updated: 2025/08/26 19:11:23 by yel-bouk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define HALF_WIN_WIDTH 810
# define MINIMAP_MAX_DISPLAYABLE_WIDTH 704
# define MINIMAP_MAX_DISPLAYABLE_HEIGHT 576
# define UI_HEIGHT 128
# define RES_PIX 64
# define FRAME_RATE 60
# define MINIMAP_MAX_DISPLAYABLE_COL 11 // HALF_WIN_WIDTH / RES_PIX
# define MINIMAP_MAX_DISPLAYABLE_ROW 9 // (WIN_HEIGHT - UI_HEIGHT) / RES_PIX
# define HORIZON_OFFSET 53
...
// Raycaster
# define NB_RAYS_CAST 800
# define FOV 1.04719755 // M_PI / 3.0f
...
int		copy_tilemap(char **dest, char **src, t_map_dir *map_dir,
			t_state *state);
